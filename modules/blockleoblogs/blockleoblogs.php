...
class Blockleoblogs extends Module
{
	...
	public function install()
	{
		...
		if (parent::install() && $this->registerHook('displayHome') && $this->registerHook('header') && $this->registerHook('displayBottom')
				&& Configuration::updateValue('BLEOBLOGS_NBR', 6) && Configuration::updateValue('BLEOBLOGS_PAGE', 3)
				&& Configuration::updateValue('BLEOBLOGS_COL', 3) && Configuration::updateValue('BLEOBLOGS_INTV', 8000)
				&& Configuration::updateValue('BLEOBLOGS_SHOW', 1) && Configuration::updateValue('BLEOBLOGS_WIDTH', 690)
				&& Configuration::updateValue('BLEOBLOGS_HEIGHT', 300) && Configuration::updateValue('BLEOBLOGS_SCATE', 1)
				&& Configuration::updateValue('BLEOBLOGS_SIMA', 1) && Configuration::updateValue('BLEOBLOGS_SAUT', 1)
				&& Configuration::updateValue('BLEOBLOGS_SCAT', 1) && Configuration::updateValue('BLEOBLOGS_SCRE', 1)
				&& Configuration::updateValue('BLEOBLOGS_STITLE', 1) && Configuration::updateValue('BLEOBLOGS_SCOUN', 1)
				&& Configuration::updateValue('BLEOBLOGS_SHITS', 1) && Configuration::updateValue('BLEOBLOGS_PARAM', $encode_parram))
		{
			$res = true;
