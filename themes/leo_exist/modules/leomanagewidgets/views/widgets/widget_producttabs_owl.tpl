...
<div id="{$myTab}" class="block products_block exclusive">
    ...
    <div class="block_content grid">
        <ul id="productTabs" class="text-center widget-tabs nav nav-pills">
                {if $newproducts}	
                <li><a href="#{$myTab}newproducts" data-toggle="tab"><span></span>{l s='New Arrivals' mod='leomanagewidgets'}</a></li>
                {/if}
                {if $featured}	
                <li><a href="#{$myTab}featured" data-toggle="tab"><span></span>{l s='Featured' mod='leomanagewidgets'}</a></li>
                {/if}
                {if $special}   
        ...
        <div id="product_tab_content">
            <div class="product_tab_content tab-content row">
                {if $newproducts}		  
