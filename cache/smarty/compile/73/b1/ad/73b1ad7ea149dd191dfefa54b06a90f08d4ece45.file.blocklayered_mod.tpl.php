<?php /* Smarty version Smarty-3.1.19, created on 2016-03-02 01:21:42
         compiled from "T:\home\stamp-expert.ru\www\modules\blocklayered_mod\blocklayered_mod.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2667656d607e6c5a190-47103787%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '73b1ad7ea149dd191dfefa54b06a90f08d4ece45' => 
    array (
      0 => 'T:\\home\\stamp-expert.ru\\www\\modules\\blocklayered_mod\\blocklayered_mod.tpl',
      1 => 1456073985,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2667656d607e6c5a190-47103787',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'img_ps_dir' => 0,
    'param_product_url' => 0,
    'blocklayered_modSliderName' => 0,
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_56d607e87149d5_80768114',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56d607e87149d5_80768114')) {function content_56d607e87149d5_80768114($_smarty_tpl) {?>

<!-- Block layered navigation module -->
<?php if ($_smarty_tpl->tpl_vars['nbr_filterBlocks']->value!=0) {?>
<div id="layered_block_left" class="block">
<h4 class="title_block layeredSortBy"><?php echo smartyTranslate(array('s'=>'Sort by:','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
</h4>
		<form action="#" id="layered_form">
			<div>
				...
				<div id="enabled_filters">
						...
						<?php echo smartyTranslate(array('s'=>'Enabled filters:','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
...
_slider" title="<?php echo smartyTranslate(array('s'=>'Cancel','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
...
<?php $_tmp2=ob_get_clean();?><?php echo smartyTranslate(array('s'=>htmlspecialchars(sprintf('%1$s: %2$s - %3$s',$_smarty_tpl->tpl_vars['filter']->value['name'],$_tmp1,$_tmp2), ENT_QUOTES, 'UTF-8', true),'mod'=>'blocklayered_mod'),$_smarty_tpl);?>

													<?php } else { ?>
														<?php echo smartyTranslate(array('s'=>htmlspecialchars(sprintf('%1$s: %2$s %4$s - %3$s %4$s',$_smarty_tpl->tpl_vars['filter']->value['name'],$_smarty_tpl->tpl_vars['filter']->value['values'][0],$_smarty_tpl->tpl_vars['filter']->value['values'][1],$_smarty_tpl->tpl_vars['filter']->value['unit']), ENT_QUOTES, 'UTF-8', true),'mod'=>'blocklayered_mod'),$_smarty_tpl);?>
...
" title="<?php echo smartyTranslate(array('s'=>'Cancel','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
"><i class="icon-remove"></i></a>
														<?php echo smartyTranslate(array('s'=>'%1$s: %2$s','mod'=>'blocklayered_mod','sprintf'=>array($_smarty_tpl->tpl_vars['filter']->value['name'],$_smarty_tpl->tpl_vars['value']->value['name'])),$_smarty_tpl);?>
...
?>
 ...
 layered_filter_center" style="display: none;">
						<?php } else { ?>
							<div class="layered_filter layered_filter_center">
						<?php }?>
                        <div class="layered_subtitle_heading title_block">
                            <div><span class="layered_subtitle "><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
 </span></div>
						</div>
						<ul id="ul_layered_<?php echo $_smarty_tpl->tpl_vars['filter']->value['type'];?>
_<?php echo $_smarty_tpl->tpl_vars['filter']->value['id_key'];?>
" class="col-lg-12 toogle_content layered_filter_ul<?php if (isset($_smarty_tpl->tpl_vars['filter']->value['is_color_group'])&&$_smarty_tpl->tpl_vars['filter']->value['is_color_group']) {?> color-group<?php }?>">
							<?php if (!isset($_smarty_tpl->tpl_vars['filter']->value['slider'])) {?>
...
?>
										...
										<li class="nomargin <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['fe']['index']>=$_smarty_tpl->tpl_vars['filter']->value['filter_show_limit']) {?>hiddable<?php }?> col-xs-12">
...
" <?php if (!$_smarty_tpl->tpl_vars['value']->value['nbr']) {?>disabled="disabled"<?php }?> style="background: <?php if (isset($_smarty_tpl->tpl_vars['value']->value['color'])) {?><?php if (file_exists((@constant('_PS_ROOT_DIR_')).("/img/co/".((string)$_smarty_tpl->tpl_vars['id_value']->value).".jpg"))) {?>url(<?php echo $_smarty_tpl->tpl_vars['img_col_dir']->value;?>
<?php echo $_smarty_tpl->tpl_vars['id_value']->value;?>
.jpg)<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['value']->value['color'];?>
<?php }?><?php } else { ?>#CCC<?php }?>; background-size: cover;" />
...
_<?php echo $_smarty_tpl->tpl_vars['filter']->value['id_key'];?>
"<?php } else { ?> class="layered_nocolor"<?php }?><?php }?>>
...
"<?php }?>>
											<option value=""><?php echo smartyTranslate(array('s'=>'No filters','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
</option>
											<?php  $_smarty_tpl->tpl_vars['value'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['value']->_loop = false;
 $_smarty_tpl->tpl_vars['id_value'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['filter']->value['values']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
">
										<?php echo smartyTranslate(array('s'=>'Range:','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
								...
								<?php } else { ?>
									...
									<li class="nomargin row">
	                                    <div class="col-xs-6 col-sm-12 col-lg-6 first-item">
	                                    	<?php echo smartyTranslate(array('s'=>'From','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
...
_range_unit">
	                                    ...
	                                    <div class="col-xs-6 col-sm-12 col-lg-6">
	                                    	<?php echo smartyTranslate(array('s'=>'to','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
...
"/>
							...
							<?php if (count($_smarty_tpl->tpl_vars['filter']->value['values'])>$_smarty_tpl->tpl_vars['filter']->value['filter_show_limit']&&$_smarty_tpl->tpl_vars['filter']->value['filter_show_limit']>0&&$_smarty_tpl->tpl_vars['filter']->value['filter_type']!=2) {?>
								<span class="hide-action more"><?php echo smartyTranslate(array('s'=>'Show more','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
</span>
								<span class="hide-action less"><?php echo smartyTranslate(array('s'=>'Show less','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
</span>
							<?php }?>
						</ul>
					</div>
...
loader.gif" alt="" />
			<br /><?php echo smartyTranslate(array('s'=>'Loading...','mod'=>'blocklayered_mod'),$_smarty_tpl);?>
...
<?php }?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('blocklayered_modSliderName'=>$_smarty_tpl->tpl_vars['blocklayered_modSliderName']->value),$_smarty_tpl);?>
<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['addJsDef'][0][0]->addJsDef(array('blocklayeredSliderName'=>$_smarty_tpl->tpl_vars['blocklayered_modSliderName']->value),$_smarty_tpl);?>
