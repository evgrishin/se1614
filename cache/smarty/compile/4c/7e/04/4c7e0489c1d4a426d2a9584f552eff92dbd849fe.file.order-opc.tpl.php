<?php /* Smarty version Smarty-3.1.19, created on 2016-03-09 23:41:04
         compiled from "T:\home\stamp-expert.ru\www\modules\onepagecheckout\views\templates\front\order-opc.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1572156e07c500c0b33-95080450%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4c7e0489c1d4a426d2a9584f552eff92dbd849fe' => 
    array (
      0 => 'T:\\home\\stamp-expert.ru\\www\\modules\\onepagecheckout\\views\\templates\\front\\order-opc.tpl',
      1 => 1456080232,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1572156e07c500c0b33-95080450',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56e07c50954cf2_48877137',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e07c50954cf2_48877137')) {function content_56e07c50954cf2_48877137($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include 'T:\\home\\stamp-expert.ru\\www\\tools\\smarty\\plugins\\modifier.regex_replace.php';
?>
...
';
    var addressUrl = '<?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink("address",true,null,"back=order-opc.php");?>
';
...
;
    ...
    var opc_scroll_cart = "<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['scroll_cart']&&$_smarty_tpl->tpl_vars['productNumber']->value;?>
";
    var opc_scroll_header_cart = "<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['scroll_header_cart']&&$_smarty_tpl->tpl_vars['productNumber']->value;?>
";
    var opc_scroll_info = "1"; 
    var opc_scroll_summary = "<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['scroll_summary']&&$_smarty_tpl->tpl_vars['productNumber']->value;?>
";
    var opc_scroll_products = "<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['scroll_products'];?>
";
    var opc_page_fading = "<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['page_fading']&&$_smarty_tpl->tpl_vars['productNumber']->value;?>
";
    var opc_fading_duration = "<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['fading_duration'];?>
";
    var opc_fading_opacity = "<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['fading_opacity'];?>
";
    var opc_sample_values = "<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['sample_values'];?>
";
    var opc_sample_to_placeholder = ('<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['sample_to_placeholder'];?>
' == '1') ? true: false;
    var opc_inline_validation = "<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['inline_validation'];?>
";
    var opc_validation_checkboxes = "<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['validation_checkboxes'];?>
";
    var opc_display_info_block = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['display_info_block'];?>
';
...
';
    var opc_before_info_element = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['before_info_element'];?>
';
    var opc_check_number_in_address = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['check_number_in_address'];?>
';
    var opc_capitalize_fields = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['capitalize_fields'];?>
';
    var opc_relay_update = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['update_payments_relay'];?>
';
    var opc_hide_carrier = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['hide_carrier'];?>
';
    var opc_hide_payment = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['hide_payment'];?>
';
    var opc_override_checkout_btn = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['override_checkout_btn'];?>
';
    var ps_guest_checkout_enabled = '<?php echo $_smarty_tpl->tpl_vars['PS_GUEST_CHECKOUT_ENABLED']->value;?>
'
    var opc_display_password_msg = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['display_password_msg'];?>
';
    var opc_live_zip = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['live_zip'];?>
';
    var opc_live_city = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['live_city'];?>
';
    var opc_cart_summary_bottom = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['cart_summary_bottom'];?>
';
    var opc_above_confirmation_message = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['above_confirmation_message'];?>
';
    var opc_order_detail_review = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['order_detail_review'];?>
';
    var opc_animate_fields_padding = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['animate_fields_padding'];?>
';
    var opc_two_column_opc = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['two_column_opc'];?>
';
    var opc_three_column_opc = ('<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['three_column_opc'];?>
' == '1') ? true: false;
    var opc_cookie_cache = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['cookie_cache'];?>
';
    var opc_move_cgv = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['move_cgv'];?>
';
    var opc_responsive_layout = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['responsive_layout'];?>
';
    var opc_company_based_vat = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['company_based_vat'];?>
';
    var opc_save_account_overlay = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['save_account_overlay'];?>
';
    var opc_payment_radio_buttons = '<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['payment_radio_buttons'];?>
';
    var opc_invoice_first = false; 
    var opc_default_ps_carriers = ('<?php echo $_smarty_tpl->tpl_vars['opc_config']->value['default_ps_carriers'];?>
' == '1') ? true : false;
