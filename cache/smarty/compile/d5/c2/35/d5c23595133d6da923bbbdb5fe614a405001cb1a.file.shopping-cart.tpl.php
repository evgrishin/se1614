<?php /* Smarty version Smarty-3.1.19, created on 2016-03-09 23:41:04
         compiled from "T:\home\stamp-expert.ru\www\modules\onepagecheckout\views\templates\front\shopping-cart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2148656e07c50979ab6-29934403%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd5c23595133d6da923bbbdb5fe614a405001cb1a' => 
    array (
      0 => 'T:\\home\\stamp-expert.ru\\www\\modules\\onepagecheckout\\views\\templates\\front\\shopping-cart.tpl',
      1 => 1456080232,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2148656e07c50979ab6-29934403',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56e07c52aeb331_22734800',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56e07c52aeb331_22734800')) {function content_56e07c52aeb331_22734800($_smarty_tpl) {?>
...
"><img
                        src="<?php echo $_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],$_smarty_tpl->tpl_vars['product']->value['id_image'],'small_default');?>
"
...
_<?php echo intval($_smarty_tpl->tpl_vars['product']->value['id_address_delivery']);?>
 <?php if ($_smarty_tpl->tpl_vars['odd']->value) {?>odd<?php } else { ?>even<?php }?> customization alternate_item <?php if ($_smarty_tpl->tpl_vars['product']->last&&$_smarty_tpl->tpl_vars['customization']->last&&!count($_smarty_tpl->tpl_vars['gift_products']->value)) {?>last_item<?php }?>">
                <td></td>
                <td colspan="<?php echo $_smarty_tpl->tpl_vars['colspan2']->value;?>
">
...
icon/quantity_up.gif" alt="<?php echo smartyTranslate(array('s'=>'Add','mod'=>'onepagecheckout'),$_smarty_tpl);?>
"
...
">
                                    <img src="<?php echo $_smarty_tpl->tpl_vars['img_dir']->value;?>
icon/quantity_down.gif" alt="<?php echo smartyTranslate(array('s'=>'Subtract','mod'=>'onepagecheckout'),$_smarty_tpl);?>
" width="14"
                                         height="9"/>
                                </a>
                                <?php } else { ?>
...
"><?php echo smartyTranslate(array('s'=>'Delete','mod'=>'onepagecheckout'),$_smarty_tpl);?>
</a>
                        </div>
                    <?php }?>
                </td>
...
">
            <td class="cart_discount_name" colspan="<?php echo $_smarty_tpl->tpl_vars['colspan2']->value;?>
...
"
                    class="cart_quantity_delete" title="<?php echo smartyTranslate(array('s'=>'Delete','mod'=>'onepagecheckout'),$_smarty_tpl);?>
"></a><?php }?><br />
...
');return false;"
                                          class="voucher_name_opc"><?php echo $_smarty_tpl->tpl_vars['voucher']->value['code'];?>
...
"><?php echo smartyTranslate(array('s'=>'Next','mod'=>'onepagecheckout'),$_smarty_tpl);?>
 &raquo;</a><?php }?>
            <a href="<?php if ((isset($_SERVER['HTTP_REFERER'])&&strstr($_SERVER['HTTP_REFERER'],'{$opckt_script_name}'))||!isset($_SERVER['HTTP_REFERER'])) {?><?php echo $_smarty_tpl->tpl_vars['link']->value->getPageLink('index.php');?>
