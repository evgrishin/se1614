<?php /* Smarty version Smarty-3.1.19, created on 2016-02-21 21:28:44
         compiled from "T:\home\stamp-expert.ru\www\themes\leo_exist\authentication.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2771756c9f3cce679e5-01491621%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4d2c78ef10179110760acda29c82da98212761a4' => 
    array (
      0 => 'T:\\home\\stamp-expert.ru\\www\\themes\\leo_exist\\authentication.tpl',
      1 => 1456074041,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2771756c9f3cce679e5-01491621',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56c9f3cfbba9c0_48409790',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56c9f3cfbba9c0_48409790')) {function content_56c9f3cfbba9c0_48409790($_smarty_tpl) {?>
			...
			<div class="box">
				<div id="opc_account_form" style="display: block; ">
					...
					<div class="required form-group">
						<label class="control-label col-sm-4 col-md-4 " for="guest_email"><?php echo smartyTranslate(array('s'=>'Email address'),$_smarty_tpl);?>
 <sup>*</sup></label>
...
<?php }?>" />
					...
					<div class="cleafix gender-line">
						<label class="control-label col-sm-4 col-md-4"><?php echo smartyTranslate(array('s'=>'Title'),$_smarty_tpl);?>
</label>
						<div class="col-sm-6 col-md-6">
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="vat_number") {?>
							<div id="vat_number" style="display:none;">
								<div class="form-group">
									<label class="control-label col-sm-4 col-md-4" for="vat-number"><?php echo smartyTranslate(array('s'=>'VAT number'),$_smarty_tpl);?>
<?php if (in_array($_smarty_tpl->tpl_vars['field_name']->value,$_smarty_tpl->tpl_vars['required_fields']->value)) {?> <sup>*</sup><?php }?></label>
									<div class="col-sm-6 col-md-6">
...
<?php }?>" />
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="Country:name"||$_smarty_tpl->tpl_vars['field_name']->value=="country") {?>
							<div class="required select form-group">
								<label class="control-label col-sm-4 col-md-4 col-lg-4" for="id_country"><?php echo smartyTranslate(array('s'=>'Country'),$_smarty_tpl);?>
 <sup>*</sup></label>
...
"<?php if ((isset($_POST['id_country'])&&$_POST['id_country']==$_smarty_tpl->tpl_vars['v']->value['id_country'])||(!isset($_POST['id_country'])&&$_smarty_tpl->tpl_vars['sl_country']->value==$_smarty_tpl->tpl_vars['v']->value['id_country'])) {?> selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['v']->value['name'];?>
						...
						<?php } elseif ($_smarty_tpl->tpl_vars['field_name']->value=="State:name") {?>
							...
							<div class="required id_state select form-group">
								<label class="control-label col-sm-4 col-md-4 col-lg-4" for="id_state"><?php echo smartyTranslate(array('s'=>'State'),$_smarty_tpl);?>
 <sup>*</sup></label>
								<div class="col-sm-6 col-md-6 col-lg-6">
...
" <?php if (isset($_POST['id_gender'])&&$_POST['id_gender']==$_smarty_tpl->tpl_vars['gender']->value->id) {?>checked="checked"<?php }?> />
			...
			<div class="required form-group">
				<label class="control-label col-sm-4 col-md-4" for="customer_firstname"><?php echo smartyTranslate(array('s'=>'First name'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-6 col-md-6">
...
<?php }?>" />
			...
			<div class="required form-group">
				<label class="control-label col-sm-4 col-md-4" for="customer_lastname"><?php echo smartyTranslate(array('s'=>'Last name'),$_smarty_tpl);?>
 <sup>*</sup></label>
				<div class="col-sm-6 col-md-6">
...
&nbsp;&nbsp;</option>
		...
		<?php if ($_smarty_tpl->tpl_vars['b2b_enable']->value) {?>
			<div class="account_creation">
				...
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for=""><?php echo smartyTranslate(array('s'=>'Company'),$_smarty_tpl);?>
</label>
					<div class="col-sm-6 col-md-6">
						<input type="text" class="form-control" id="company" name="company" value="<?php if (isset($_POST['company'])) {?><?php echo $_POST['company'];?>
<?php }?>" />
				...
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for="siret"><?php echo smartyTranslate(array('s'=>'SIRET'),$_smarty_tpl);?>
</label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
				...
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for="ape"><?php echo smartyTranslate(array('s'=>'APE'),$_smarty_tpl);?>
</label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
				...
				<div class="form-group">
					<label class="control-label col-sm-4 col-md-4" for="website"><?php echo smartyTranslate(array('s'=>'Website'),$_smarty_tpl);?>
</label>
					<div class="col-sm-6 col-md-6">
...
<?php }?>" />
				...
				<div class="required form-group" id="address_alias">
					<label class="control-label col-sm-4 col-md-4" for="alias"><?php echo smartyTranslate(array('s'=>'Assign an address alias for future reference.'),$_smarty_tpl);?>
 <sup>*</sup></label>
					<div class="col-sm-6 col-md-6">
