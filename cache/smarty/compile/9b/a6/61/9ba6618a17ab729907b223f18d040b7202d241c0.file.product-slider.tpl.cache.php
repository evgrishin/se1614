<?php /* Smarty version Smarty-3.1.19, created on 2016-02-21 21:46:22
         compiled from "T:\home\stamp-expert.ru\www\themes\warehouse\product-slider.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1929056c9f7ee8d99e2-99456806%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9ba6618a17ab729907b223f18d040b7202d241c0' => 
    array (
      0 => 'T:\\home\\stamp-expert.ru\\www\\themes\\warehouse\\product-slider.tpl',
      1 => 1456073982,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1929056c9f7ee8d99e2-99456806',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56c9f7f0430671_63186000',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56c9f7f0430671_63186000')) {function content_56c9f7f0430671_63186000($_smarty_tpl) {?>	<?php if (isset($_smarty_tpl->tpl_vars['products']->value)&&$_smarty_tpl->tpl_vars['products']->value) {?>
...
?>
				<?php if (isset($_smarty_tpl->tpl_vars['colnb']->value)) {?><?php if (($_smarty_tpl->getVariable('smarty')->value['foreach']['homeFeaturedProducts']['first'])) {?><div class="iqitcarousel-produc"><?php }?><?php }?>
...
" >
							...
							<img class="replace-2x img-responsive img_0 <?php if (isset($_smarty_tpl->tpl_vars['productimg']->value[$_smarty_tpl->tpl_vars['product']->value['id_product']][1])&&!empty($_smarty_tpl->tpl_vars['productimg']->value[$_smarty_tpl->tpl_vars['product']->value['id_product']][1])) {?> img_1e<?php }?>" alt="<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['legend'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
...
"<?php }?>
							data-lazy="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],(($_smarty_tpl->tpl_vars['product']->value['id_product']).("-")).($_smarty_tpl->tpl_vars['productimg']->value[$_smarty_tpl->tpl_vars['product']->value['id_product']][0]['id_image']),'home_default'), ENT_QUOTES, 'UTF-8', true);?>
"							
							 />	
							...
							<img class="replace-2x img-responsive img_1" title="<?php if (!empty($_smarty_tpl->tpl_vars['product']->value['legend'])) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['legend'], ENT_QUOTES, 'UTF-8', true);?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
<?php }?>" <?php if (isset($_smarty_tpl->tpl_vars['homeSize']->value)) {?> width="<?php echo $_smarty_tpl->tpl_vars['homeSize']->value['width'];?>
" height="<?php echo $_smarty_tpl->tpl_vars['homeSize']->value['height'];?>
"<?php }?>  data-lazy="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getImageLink($_smarty_tpl->tpl_vars['product']->value['link_rewrite'],(($_smarty_tpl->tpl_vars['product']->value['id_product']).("-")).($_smarty_tpl->tpl_vars['productimg']->value[$_smarty_tpl->tpl_vars['product']->value['id_product']][1]['id_image']),'home_default'), ENT_QUOTES, 'UTF-8', true);?>
...
"><?php echo smartyTranslate(array('s'=>'Add to Compare'),$_smarty_tpl);?>
				...
				<?php if (isset($_smarty_tpl->tpl_vars['allow_oosp']->value)) {?>
							...
							<span  class="availability availability-slidein">
								...
								<?php } else { ?>
									<span class="out-of-stock">
										<link /><?php echo smartyTranslate(array('s'=>'Out of stock'),$_smarty_tpl);?>
